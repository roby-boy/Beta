...
Construction of the beta platform will be carried out through the Beta repository and coordinated using milestones and issues. To get involved, review the [Design Overview](https://github.com/BeehiveNGO/Beta/blob/master/Beta_Design_Overview.md), join the project's relivant [GitHub team/s](https://github.com/BeehiveNGO/Teams) and corresponding Slack channels then let us know where and how you'd like to contribute.
